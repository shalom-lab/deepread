...
- 👁️‍🗨️ **全格式附件感知**：支持投喂母文献下所有的 **PDF、Word (.doc/.docx) 及 CAJ** 附件，利用 Gemini 的原生多模态或超长上下文能力直接分析文档原始内容。
...
### v0.6.0
- ✨ **多格式支持**：新增对 **Word (.doc, .docx)** 和 **CAJ (.caj)** 格式附件的支持，自动识别并投喂给 AI。
